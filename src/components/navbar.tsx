...
<div className="bg-purple-500 absolute -top-3 -right-3 w-5 h-5 flex items-center justify-center rounded-full text-white text-xs">1</div>
</div>

<div className="flex flex-col">
<span className="text-xs leading-3 font-medium">Joe doue</span>
